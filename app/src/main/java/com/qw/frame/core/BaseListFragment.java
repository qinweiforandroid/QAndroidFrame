 ...
 */
public abstract class BaseListFragment<T> extends BaseFragment implements PullRecyclerView.OnPullRecyclerListener {
    ...
    protected void initializeView(View v) {
        mPullRecycler = (PullRecyclerView) v.findViewById(R.id.mPullRecyclerView);
    ...
    class ListAdapter extends BaseListAdapter<T> {
        ...
        public QBaseViewHolder onCreateAdapterView(ViewGroup parent, int viewType) {
            return BaseListFragment.this.onCreateAdapterView(LayoutInflater.from(getActivity()), parent, viewType);
        }

        @Override
        protected int getAdapterItemViewType(int position) {
            return BaseListFragment.this.getAdapterItemViewType(position);
        }
    ...
    public ILayoutManager getLayoutManager() {
        return new MLinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
    }
